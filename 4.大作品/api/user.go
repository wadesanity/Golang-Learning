...
func UserRegister(c *gin.Context) {
	...
	c.JSON(http.StatusOK, types.UserRegisterRes{
...
func UserLogin(c *gin.Context) {
	...
	c.JSON(http.StatusOK, types.UserLoginRes{
		Status: http.StatusOK,
		Msg:    "用户登录成功",
		Token:  s,
	})
...
func UserChangePwd(c *gin.Context) {
	...
	c.JSON(http.StatusOK, types.UserChangePwdRes{
		Status:   http.StatusOK,
		Msg:      "修改密码成功",
		UpdateAt: *t,
	})
...
func UserList(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusBadRequest, types.NewResError(http.StatusBadRequest, e.ReqParamsError))
		return
	}
	...
	if err != nil {
		...
		c.JSON(apiError.HttpStatus, types.NewResError(apiError.HttpStatus, apiError))
		return
	}
	c.JSON(http.StatusOK, types.NewResList(res, total, "用户列表查询成功"))
}
